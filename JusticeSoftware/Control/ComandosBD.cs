...
namespace JusticeSoftware.Classes
{
    class ComandosBD 
    {
        SqlConnection conecta = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Danielle\OneDrive\Área de Trabalho\backup main\JusticeSoftware\JusticeSoftware\BancoDeDados.mdf;Integrated Security=True");
        SqlCommand CMD;
